...
<head>
<meta charset="utf-8" />
<title>BBA DMS | Logger Engineer Center</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	...
	<script src="/js/vehicle/ajax.js" type="text/javascript"></script>
	<script src="/js/vehicle/main.js" type="text/javascript"></script>
	<script src="/js/vehicle/add-new.js" type="text/javascript"></script>
	<script src="/js/vehicle/delete.js" type="text/javascript"></script>
	<script src="/js/vehicle/edit.js" type="text/javascript"></script>
	<script src="/js/vehicle/view.js" type="text/javascript"></script>
	
	<script src="/js/vehicle/import.js" type="text/javascript"></script>
