...
<body id="last-main" class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	<!-- BEGIN HEADER -->
	...
	<script src="/js/common/jasny-bootstrap.min.js" type="text/javascript"></script>
	...
	<script src="/js/management/project/view.js" type="text/javascript"></script>
