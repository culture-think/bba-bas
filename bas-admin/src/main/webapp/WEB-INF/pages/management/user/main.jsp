...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	...
	<script src="/js/management/user/ajax.js" type="text/javascript"></script>
	<script src="/js/management/user/main.js" type="text/javascript"></script>
	<script src="/js/management/user/add-new.js" type="text/javascript"></script>
	<script src="/js/management/user/delete.js" type="text/javascript"></script>
	<script src="/js/management/user/edit.js" type="text/javascript"></script>
	<script src="/js/management/user/view.js" type="text/javascript"></script>
