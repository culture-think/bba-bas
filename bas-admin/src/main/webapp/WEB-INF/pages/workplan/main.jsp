...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	...
	<script src="/js/workplan/ajax.js" type="text/javascript"></script>
	<script src="/js/workplan/main.js" type="text/javascript"></script>
	<script src="/js/workplan/sidebar.js" type="text/javascript"></script>

	<script src="/js/common/page-header.js" type="text/javascript"></script>
	<script src="/js/common/jquery.multi-select.js" type="text/javascript"></script>
