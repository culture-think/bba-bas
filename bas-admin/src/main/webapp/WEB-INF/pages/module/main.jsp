...
<head>
<meta charset="utf-8" />
<title>BBA ATG DRIVE EVENT | Module Management</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	...
	<div class="page-container">
		...
		<!-- BEGIN SIDEBAR -->
		<%@ include file="../page-sidebar.html"%>
		<!-- END SIDEBAR -->
		...
		<!-- BEGIN QUICK SIDEBAR -->
		<%@ include file="/page-quick-sidebar.html"%>
		<!-- END QUICK SIDEBAR -->
	...
	<script src="/js/common/page-sidebar.js" type="text/javascript"></script>
	
	<script src="/js/module/ajax.js" type="text/javascript"></script>
	<script src="/js/module/main.js" type="text/javascript"></script>
	<script src="/js/module/add-new.js" type="text/javascript"></script>
	<script src="/js/module/delete.js" type="text/javascript"></script>
	<script src="/js/module/edit.js" type="text/javascript"></script>
	<script src="/js/module/view.js" type="text/javascript"></script>
