...
<head>
<meta charset="utf-8" />
<title>BBA ATG DRIVE EVENT | User Management</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	...
	<script src="/js/user/ajax.js" type="text/javascript"></script>
	<script src="/js/user/main.js" type="text/javascript"></script>
	<script src="/js/user/add-new.js" type="text/javascript"></script>
	<script src="/js/user/delete.js" type="text/javascript"></script>
	<script src="/js/user/edit.js" type="text/javascript"></script>
	<script src="/js/user/view.js" type="text/javascript"></script>
