var EditDefinition = function () {
	var initProjectSelect = function() {
        var result = DefinitionAjax.getProjects();
        if (!result) {
            return;
        }
        var optionContent
        ...
        $("#form_definition-edit #project").html(optionContent);
    }
    ...
    var handleValidation = function() {
        ...
        form.validate({
            ...
            submitHandler: function (form) {
                ...
                var definition = {
                		loginName: $("#form_definition-edit #loginName").val(),
                		projectId: $("#form_definition-edit #project option:selected").val()
                };
    ...
    var inject = function(entity) {
    	...
    	if (result.success) {
            ...
            $("#form_definition-edit #loginName").val(definitionInfo.loginName||"");
            $("#form_definition-edit #project").select2('val',definitionInfo.projectId);
